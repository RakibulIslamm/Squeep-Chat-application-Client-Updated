    ...
    return (
        <Link to={`/inbox/messages/${_id}`}>
            <div className='flex items-center gap-2 p-3 hover:bg-primary'>
                <img className='w-[30px] object-cover rounded-full' src={participant?.img || "https://png.pngtree.com/png-vector/20190114/ourlarge/pngtree-vector-avatar-icon-png-image_313572.jpg"} alt="" />
